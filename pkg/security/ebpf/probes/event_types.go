...
// ProbesSelectorsPerEventType is the list of probes that should be activated for each event
var ProbesSelectorsPerEventType = map[string][]manager.ProbesSelector{
